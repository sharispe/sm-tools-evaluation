package slib.quicktest.sm_tools_evaluation.go;
...
/**
 * Generate the benchmarks composed of pairs of GO terms and pairs of gene ids. 
 * This class generates:
 * - TSV files containing pairs of GO terms identifiers (one per line). 
 * Four sizes of benchmarks are considered (1K, 10K, 1M and 100M). For each size, three sets of pairs are generated.
 *
 * The benchmarks are built selecting random pairs of terms specified in the
 * Biological Process aspect of the GO. In other terms, all pairs are of classes
 * are composed of classes subsumed by GO:0008150. All terms of composing the sample
 * are at least used to annotated one gene.
 * 
 * - TSV files containing pairs of gene identifiers identifiers (one per line). 
 * Four sizes of benchmarks are considered (1K, 10K, 1M and 100M). For each size, three sets of pairs are generated.
 *
 * @author Sébastien Harispe
 */
public class BenchmarkBuilder_GO {
    ...
    public static void main(String[] args) {
        ...
        String root_dir = "/home/seb/dev/java/workspace/sml-tools-evaluation/resources/data/go/";
